...
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, existingUser, newUser, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                newUser = new User_1.default({ name: name, email: email, password: password });
                return [4 /*yield*/, newUser.save()];
            case 3:
                _b.sent();
                token = jsonwebtoken_1.default.sign({ id: newUser._id }, process.env.JWT_SECRET_KEY, {
                    expiresIn: '30d',
                });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ id: user._id }, process.env.JWT_SECRET_KEY, {
                    expiresIn: '30d',
                });
                // Send the response with the user and token
