...
var userResolver = {
    Mutation: {
        register: function (_1, _a) { return __awaiter(void 0, [_1, _a], void 0, function (_, _b) {
            var user, token;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { id: user._id, username: user.username, email: user.email, token: token }];
                }
            });
        }); },
